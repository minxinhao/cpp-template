...
struct task
{
    ...
    struct promise_type
    {
        ...
        std::suspend_never final_suspend() noexcept
        {
            ...
            std::cout << "14.don't suspend because return std::suspend_never, and the continue will be automatically "
                         "destroyed, bye\n";
            return {};
        }
        void return_void()
...
task test()
{
    ...
    co_await awaiter{};
    std::cout << "11.coroutine resumed, continue execcute coroutine body now, the thread id="
